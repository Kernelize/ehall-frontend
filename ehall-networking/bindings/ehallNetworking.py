...
def _uniffi_load_indirect():
    ...
    libname = libname.format("uniffi_ehallNetworking")
...
def _uniffi_check_api_checksums(lib):
    if lib.uniffi_ehall_networking_checksum_func_rust_add() != 49749:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ehall_networking_checksum_func_rust_greeting() != 38795:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ehall_networking_checksum_func_rust_tokio_test() != 28974:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_ehall_networking_fn_func_rust_tokio_test.argtypes = (
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ehall_networking_fn_func_rust_tokio_test.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_ehall_networking_checksum_func_rust_tokio_test.argtypes = (
)
_UniffiLib.uniffi_ehall_networking_checksum_func_rust_tokio_test.restype = ctypes.c_uint16
...
def rust_tokio_test() -> "str":
    return _UniffiConverterString.lift(_rust_call(_UniffiLib.uniffi_ehall_networking_fn_func_rust_tokio_test,))
